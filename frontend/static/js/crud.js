...
async function saveReserva() {
  ...
  if (idReserva !== "") {
    result = await fetchData(
      `${BASEURL}/api/reservaciones/${idReserva}`,
      "PUT",
      reservaData
    );
  } else {
...
async function showReservaciones() {
  ...
  const tableReservaciones = document.querySelector(
    "#list-table-reservaciones tbody"
  );
  ...
  reservaciones.forEach((reserva, index) => {
    let tr = `<tr>
                  ...
                  <td>
                      <button class="btn-update" onclick='updateReserva(${reserva.id_reserva})'><i class="fa fa-pencil" ></button></i>
                      <button class="btn-delete" onclick='deleteReserva(${reserva.id_reserva})'><i class="fa fa-trash" ></button></i>
                  </td>
                </tr>`;
